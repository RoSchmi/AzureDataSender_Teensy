...
For details how to use have a look on this project
...
There are two hacks which are needed to achieve that this application works on the Teensy:
...
2) For Teensyduino v1.53 the libraries 'FNET' and 'NativeEthernet' in C:\Users\thisuser\.platformio\packages\framework-arduinoteensy\libraries have to be exchanged with the        latest (act. 22.03.2021) libraries of -https://github.com/vjmuzik/NativeEthernet#master
