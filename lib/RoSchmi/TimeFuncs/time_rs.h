// RoSchmi:
// This file has the same content as time.h.
// The inclusion of the C library time.h is prevented by properties of the Time.h lib on Teensy
// So this ugly hack was used
